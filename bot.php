...
[["text" =>"تشغيل او ايقاف"]],
[["text" =>"عرض او حذف اليوزرات"],["text" =>"الضغطات"]],
[["text" =>"--------------------------------------"]],
...
##عرض السته او حذف##
if ($chat_id == $group) {
if ($text == "عرض او حذف اليوزرات") {
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "𖠜 Select button",
'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
[["text" =>"->"]],
[["text" =>"Show All - 1"],["text" =>"Delete list 1"]],
[["text" =>"Show All - 2"],["text" =>"Delete list 2"]],
[["text" =>"Show All - 3"],["text" =>"Delete list 3"]],
[["text" =>"Show All - 4"],["text" =>"Delete list 4"]],
[["text" =>"Show All - 5"],["text" =>"Delete list 5"]]],]) ]);
}}
...
if (preg_match('/Delete list \d+/',$text)){
$ex = explode('Delete list ',$text);
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "Done Delete all Usernames List ".$ex[1],'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم كلاوات", 'url' => "https://t.me/Tim_Klawat"]],
]])]);
